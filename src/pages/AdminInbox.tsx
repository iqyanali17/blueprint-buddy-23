...
const AdminInbox: React.FC = () => {
  ...
  const isAdmin = (user?.user_metadata as any)?.account_type === 'admin';
    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <Badge variant="outline" className="border-emergency text-emergency">Admin Inbox</Badge>
          <h2 className="text-3xl font-bold mt-2">All Messages</h2>
        </div>
        <Card className="max-w-6xl mx-auto grid md:grid-cols-3">
          ...
          <div className="md:col-span-2 p-4 flex flex-col h-[560px]">
            ...
            <div className="mt-3 flex items-center gap-2">
              <Input value={reply} onChange={(e)=>setReply(e.target.value)} placeholder="Type a system reply or forward…" />
